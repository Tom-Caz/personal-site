/* empty css                           */
import { c as createAstro, d as createComponent, r as renderTemplate, e as addAttribute, m as maybeRenderHead, A as AstroError, f as ExpectedImageOptions, E as ExpectedImage, g as InvalidImageService, h as ImageMissingAlt, s as spreadAttributes, i as defineScriptVars, j as renderComponent, k as renderHead, l as renderSlot } from '../astro_mIQtAQPs.mjs';
import 'kleur/colors';
import 'clsx';
import { i as isESMImportedImage, a as isLocalService, b as isRemoteImage, D as DEFAULT_HASH_PROPS } from '../astro/assets-service_vMopOvLK.mjs';

const $$Astro$a = createAstro("https://thomascazort.dev");
const $$BaseHead = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$a, $$props, $$slots);
  Astro2.self = $$BaseHead;
  const { title, description, image = "/LA.jpeg" } = Astro2.props;
  return renderTemplate`<!-- Global Metadata --><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><meta name="generator"${addAttribute(Astro2.generator, "content")}><!-- Primary Meta Tags --><title>${title}</title><meta name="title"${addAttribute(title, "content")}><meta name="description"${addAttribute(description, "content")}><!-- Open Graph / Facebook --><meta property="og:url"${addAttribute(Astro2.url, "content")}><meta property="og:title"${addAttribute(title, "content")}><meta property="og:description"${addAttribute(description, "content")}><meta property="og:image"${addAttribute(new URL(image, Astro2.url), "content")}><!-- Twitter --><meta property="twitter:card" content="summary_large_image"><meta property="twitter:url"${addAttribute(Astro2.url, "content")}><meta property="twitter:title"${addAttribute(title, "content")}><meta property="twitter:description"${addAttribute(description, "content")}><meta property="twitter:image"${addAttribute(new URL(image, Astro2.url), "content")}>`;
}, "/Users/tomcaz/p/personal-site/src/components/BaseHead.astro", void 0);

const $$Astro$9 = createAstro("https://thomascazort.dev");
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$9, $$props, $$slots);
  Astro2.self = $$Header;
  return renderTemplate`${maybeRenderHead()}<div class="sticky lg:hidden top-0 z-30 flex h-16 w-full justify-center bg-opacity-90 backdrop-blur transition-all duration-100 bg-base-100 text-base-content shadow-sm"> <div class="navbar"> <div class="navbar-start"> <label for="my-drawer" class="btn btn-square btn-ghost"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block w-5 h-5 stroke-current"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path> </svg> </label> </div> <div class="navbar-center"> <a class="btn btn-ghost normal-case text-xl" href="/">Thomas Cazort</a> </div> <div class="navbar-end"></div> </div> </div>`;
}, "/Users/tomcaz/p/personal-site/src/components/Header.astro", void 0);

const $$Astro$8 = createAstro("https://thomascazort.dev");
...
&copy; ${today.getFullYear()} Thomas Cazort
...
const $$Astro$6 = createAstro("https://thomascazort.dev");
...
}, "/Users/tomcaz/p/personal-site/node_modules/astro/components/Image.astro", void 0);
...
}, "/Users/tomcaz/p/personal-site/node_modules/astro/components/Picture.astro", void 0);

const imageConfig = {"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":[],"remotePatterns":[]};
					new URL("file:///Users/tomcaz/p/personal-site/.vercel/output/static/");
...
const $$SideBarMenu = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template(["", '<ul class="menu grow shrink menu-md overflow-y-auto"> <li><a class="py-3 text-base" id="home" href="/">Home</a></li> <li> <a class="py-3 text-base" id="workxp" href="/#Work-Experience">Work Experience</a> </li> <li> <a class="py-3 text-base" id="education" href="/#Education">Education</a> </li> <li> <a class="py-3 text-base" id="projects" href="/#Projects">Projects</a> </li> <div class="divider p-5"></div> <li><a class="py-3 text-base" id="cv" href="/cv">CV</a></li> <li> <a class="py-3 text-base" href="mailto:thomas.cazort@outlook.com" target="_blank" referrerpolicy="no-referrer-when-downgrade">Contact</a> </li> </ul> <script>(function(){', "\nconst activeItemElem = document.getElementById(sideBarActiveItemID);\nactiveItemElem && activeItemElem.classList.add(activeClass);\n})();<\/script>"])), maybeRenderHead(), defineScriptVars({ sideBarActiveItemID, activeClass }));
}, "/Users/tomcaz/p/personal-site/src/components/SideBarMenu.astro", void 0);
...
const $$SideBar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$SideBar;
  const { sideBarActiveItemID } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<div class="drawer-side z-40"> <label for="my-drawer" class="drawer-overlay"></label> <aside class="px-2 pt-2 h-auto min-h-full w-[19rem] bg-base-200 text-base-content flex flex-col"> <div class="w-fit mx-auto mt-5 mb-6"> <a href="/"> <div class="avatar transition ease-in-out hover:scale-[102%] block m-auto"> <div class="w-[8.5rem]"> ${renderComponent($$result, "Image", $$Image, { "class": "mask mask-circle", "aspectRatio": "1:1", "format": "webp", "width": 300, "height": 300, "src": "/profile.jpeg", "alt": "Profile image" })} </div> </div> </a> </div> ${renderComponent($$result, "SideBarMenu", $$SideBarMenu, { "sideBarActiveItemID": sideBarActiveItemID })} ${renderComponent($$result, "SideBarFooter", $$SideBarFooter, {})} </aside> </div>`;
}, "/Users/tomcaz/p/personal-site/src/components/SideBar.astro", void 0);
...
}, "/Users/tomcaz/p/personal-site/node_modules/astro/components/ViewTransitions.astro", void 0);

const SITE_TITLE = "Thomas Cazort Portfolio";
const SITE_DESCRIPTION = "Thomas Cazort - Full Stack Engineer";
...
}, "/Users/tomcaz/p/personal-site/src/layouts/BaseLayout.astro", void 0);
...
}, "/Users/tomcaz/p/personal-site/src/pages/404.astro", void 0);

const $$file = "/Users/tomcaz/p/personal-site/src/pages/404.astro";
const $$url = "/404";
